...
clip.mixcure <- function (obj = NULL, variable = NULL, pl =F , ci.level = c(0.025, 0.975), 
  ...
  inner.CLIP <- function(myvar) {
    ...
    #source(paste0(Sys.getenv("SCRATCH"), "/CLIP_simu/Her2/mixcure.clip.pdf.r"))
    source('C:\\Biostats_PhD\\Missing imputation studies\\continue2017\\programming\\mixcure.clip.pdf.r')
